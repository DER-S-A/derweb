class Rentabilidad extends ComponentManager {
    ...
    __filtrarBoxesParaMarcas(consulta, objMarcas, objRubros, objSubrubros, rubros, subrubros) {
        ...
        if(objRubros.value == 'TODAS') {
            ...
            //parametros = `where=${this.__crearConsultaParaFiltro(objMarcas, objRubros, objSubrubros, 'marcas')}`;
            parametros = 'where=id_rubro=' + objRubros.value + ' AND id_subrubro=' + objSubrubros.value;
