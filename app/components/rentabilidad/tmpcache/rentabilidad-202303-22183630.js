class Rentabilidad extends ComponentManager {
    ...
    cargarTabla(marcas, rubros, subrubros) {
        ...
        botonAgregar.addEventListener('click', () => {
            ...
            if(!this.__validarElegirUnaMinimo(objTemporal)) {
                return;
            }
            if(!this__validarValoresMargen(objTemporal.margen1, objTemporal.margen2)) {
               return; 
            }
    ...
    __validarElegirUnaMinimo(objTemporal) {
        if(objTemporal.marca == 'TODAS' && objTemporal.rubro == 'TODAS' && objTemporal.subrubro == 'TODAS') {
            return false;
        }
        return true;
    }
