class Rentabilidad extends ComponentManager {
    ...
    cargarTabla() {
        ...
        botonAgregar.addEventListener('click', () => {
            ...
            dataTableRenta.row.add([selectMarcas.options[select.selectedIndex].text, selectRubros.options[select.selectedIndex].text, selectSubrubros.options[select.selectedIndex].text, margen1.value, margen2.value]);
            dataTableRenta.draw();
        })
    }
