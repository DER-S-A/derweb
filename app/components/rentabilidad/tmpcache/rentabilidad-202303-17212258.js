class Rentabilidad extends ComponentManager {
    ...
    cargarTabla() {
        ...
        botonAgregar.addEventListener('click', () => {
            console.log(dataTableRenta.data());
            dataTableRenta.row.add([selectMarcas.innerText, selectRubros.innerText, selectSubrubros.innerText, margen1.value, margen2.value]);
            dataTableRenta.draw();
        })
    }
