class Rentabilidad extends ComponentManager {
    ...
    cargarTabla() {
        ...
        botonAgregar.addEventListener('click', () => {
            this.__pintarTabla(objTabla, selectMarcas, selectRubros, selectSubrubros, margen1, margen2);
            
        })
    }

    __pintarTabla(objTabla, selectMarcas, selectRubros, selectSubrubros, margen1, margen2) {
