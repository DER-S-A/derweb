class Rentabilidad extends ComponentManager {
    ...
    cargarTabla() {
        ...
        let botonAgregar = document.querySelector('#buttonR');
        ...
        botonAgregar.addeventListener('click', () => {console.log('hola')
            //dataTableRenta.row.add([selectMarcas.value, selectRubros.value, selectSubrubros.value, margen1.value, margen2.value]);
            //dataTableRenta.draw();
        })
    }
