    ...
    __crearGridItems() {
        ...
        this.__objDataGrid = $("#ipr_grid_items").DataTable({
            ...
            columns: [
                ...
                {data: "cantidad", title: "Cantidad", type: 'num', render: (data, type, row, meta) => {
                    if (type === "display")
                ...
                {data: "subtotal", title: "Subtotal", type: 'num', render: (data, type, row, meta) => {
                    if (type === "display")
                        return "<div style='text-align: right;'>" + Intl.NumberFormat("es-ES").format(data.toFixed(2)) + '</div>';
                    else
                        return data;
                }}
            ]
