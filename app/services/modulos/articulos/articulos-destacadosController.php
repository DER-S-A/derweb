<?php
/**
 * Clase para controlar API articulos_destacados
 */
class Articulos_destacadosController extends APIController {
    /**
     * listarPorId
     * Recupera registros de articulos_destacados.
    ...
    private function ejecutarMetodoGet($xfilter = "") {
        $objModel = new Articulos_destacadosModel();
