<?php
/**
 * Clase para controlar API tipos_entidades
 */
class Tipos_entidadesController extends APIController {
    /**
     * listarPorId
     * Recupera registros de tipos_entidades.
    ...
    private function ejecutarMetodoGet($xfilter = "") {
        $objModel = new Tipos_entidadesModel();
