//** AnyLink CSS Mefnu v2.0- (c) Dynamic Drive DHTML code library: http://www.dynamicdrive.com
...
getoffset:function(what, offsettype){
	//console.log('getoffset(): ' + what.id + '|'  + what.offsetParent + '|' + offsettype);
	return (what.offsetParent) ? what[offsettype]+this.getoffset(what.offsetParent, offsettype) : what[offsettype]
},

getoffsetof:function(el){
	el._offsets={left:this.getoffset(el, "offsetLeft"), top:this.getoffset(el, "offsetTop"), h: el.offsetHeight}
//	el._offsets={left:this.getoffset(el, "offsetLeft"), top:100, h: el.offsetHeight}
},
