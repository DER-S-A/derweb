...
var Sort = (function(){
	...
	sort.date.formats = [
		...
		// MM/DD/YY[YY] or MM-DD-YY[YY] -- comentado para que no haga matching antes que el formato dd/mm/aaaa
	...
	table.filter = function(o,filters,args) {
		...
		if (!filters) {
			...
			if (filters.nodeName=="INPUT" && filters.type=="text") {
				//Por MC: agregué ".*" para buscar en cualquier parte del string
