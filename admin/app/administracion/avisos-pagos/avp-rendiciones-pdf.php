 ...
 */
 ...
 class AVPRendicionesPDF extends FPDF {
    ...
    function Header() {
        ...
        $rsRendicion = $objModel->getRendicion($this->idRendicion);
        ...
        $this->Image("app/logo.png", 8, 5, 30);
    ...
    public function imprimir() {
        $aResponse = [];
        $path = "ufiles/avisos-pagos/";
        $fileName = "rendicion_admin_" . $this->idRendicion . ".pdf";
        $this->AddPage('L', 'A4');
        $this->generarReport();
        ...
        $aResponse["archivo_pdf"] = $aPath[1];
        $aResponse["file_name"] = $fileName;
        $aResponse["path_to_update"] = $aPath[1] . "/" . $fileName;
        return $aResponse;
    }
 }
