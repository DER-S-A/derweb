 ...
 */
function emaEnviarEmailing($xiddestino, $xidtemplate, $xcc, $xprueba, $xlog = 1, $xaTildados = [])
{
 ...
 */
function emaEnviarEmailingRs($xrs, $xidtemplate, $xcc, $xprueba, $xlog = 1, $xantispam = false, $xaTildados = [])
{
 ...
 */
function emaEnviarEmailingText($xrs, $xtemplateText, $xtemplateName, $xcc, $xprueba, $xlog = 1, $xantispam = false, $xattachs = 0, $xagrupaEmails = false, $xaTildados = [], $xFromForzado = "")
{
	$MAX = 700;
	if ($xprueba == 1)
		$MAX = 3;
