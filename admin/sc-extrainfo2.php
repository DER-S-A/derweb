...
<form method="post" name="form1" id="form1">
  ...
  <table class="dlg">
	...
	?>
    <tr>
      <td width="200" class="td_etiqueta">Nota:</td>
      <td class="td_dato">
        <?php 
    ...
    <tr>
     ...
     <tr>
      <td class="td_etiqueta">Adjunto 1:</td>
      <td class="td_dato">
        <?php
    ...
    <tr>
      <td class="td_etiqueta">Adjunto 2:</td>
      <td class="td_dato">
        <?php
