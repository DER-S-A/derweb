...
function linkMenu($xkey, $xrecord, $xnro, $xquery, $xsql, $xstackname = "")
{
	...
	$str = "<div class=\"link-menu\">
		<table class=\"menuEditar\">";
	...
	$area1->setHeaderClass("sc3-accordion menu-derecho");
						...
						<tr>
							<td valign="top">
								...
								<table width="99%">
									...
									<tr>
										<td colspan="2">
											<div class="div-container" id="div-container1">
												...
												foreach ($grupos as $grupoActual) {
													...
													while ($i < $rsPpal->cantF()) {
														...
														if ($pos === FALSE && ($visible == 1)) {
															...
															if (sonIguales($grupoActual, $fieldGroup) || (sonIguales("", $fieldGroup) && sonIguales("Datos", $grupoActual))) {
