...
<table class="dlg">
	...
	<td class="td_dato">
		...
		if (enviado())
		{
			...
			$carpetasEnDeploy = array();
			$carpetasEnDeploy[] = "/";
			$carpetasEnDeploy[] = "/sp";
			$carpetasEnDeploy[] = "/controles";
			$carpetasEnDeploy[] = "/images";
			$carpetasEnDeploy[] = "/scripts";
			$carpetasEnDeploy[] = "/css";
			$carpetasEnDeploy[] = "/scripts/autosuggest";
			$carpetasEnDeploy[] = "/scripts/quill";
			$carpetasEnDeploy[] = "/scripts/chartjs";

			$carpetasEnDeploy[] = "/terceros";
			$carpetasEnDeploy[] = "/terceros/cezpdf";
			$carpetasEnDeploy[] = "/terceros/cezpdf/src";
			$carpetasEnDeploy[] = "/terceros/cezpdf/src/include";
			$carpetasEnDeploy[] = "/terceros/cezpdf/src/fonts";
			$carpetasEnDeploy[] = "/terceros/cezpdf/extensions";
			$carpetasEnDeploy[] = "/terceros/adminer";
			$carpetasEnDeploy[] = "/terceros/ws-nusoap-0.9.5/lib";
			...
			sc3Deploy($carpetasEnDeploy, $dias);
